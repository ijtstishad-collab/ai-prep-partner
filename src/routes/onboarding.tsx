        ...
        <Card className="p-6 shadow-soft">
          ...
          <form onSubmit={submit} className="space-y-4">
            ...
            <div>
              ...
              <Input type="number" min={2024} max={2035} value={form.target_exam_year} onChange={(e) => setForm({ ...form, target_exam_year: Number(e.target.value) })} required />
            </div>
            <Button className="w-full" disabled={busy}>{busy ? "Saving..." : "Continue to Dashboard"}</Button>
          </form>
        </Card>
      </div>
    </AppShell>
